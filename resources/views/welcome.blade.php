...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        <a class="navbar-brand" href="index.html"><img src="{{ asset('home/images/logo.png') }}" class="img-fluid" alt="logo"></a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            <h1>Tickel</h1>
            <p class="tagline">Aplikasi pembelian tiket pesawat dan kereta api di Indonesia.</p>
        </div>
    ...
    <div class="client-logos my-5">
        <div class="container text-center">
            <img src="{{ asset('home/images/client-logos.png') }}" alt="client logos" class="img-fluid">
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="perspective-phone">
                <img src="{{ asset('home/images/perspective.png') }}" alt="perspective phone" class="img-fluid">
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        <img src="{{ asset('home/images/graphic.png') }}" alt="graphic" class="img-fluid rounded align-self-start mr-lg-5 mb-5 mb-lg-0">
                        <div>
    ...
    <div class="section light-bg" id="gallery">
        <div class="container">
            ...
            <div class="img-gallery owl-carousel owl-theme">
                <img src="{{ asset('home/images/screen1.jpg') }}" alt="image">
                <img src="{{ asset('home/images/screen2.jpg') }}" alt="image">
                <img src="{{ asset('home/images/screen3.jpg') }}" alt="image">
                <img src="{{ asset('home/images/screen1.jpg') }}" alt="image">
            </div>
        ...
        <div class="container">
            <div class="call-to-action">
                ...
                <div class="my-4">
                    ...
                    <a href="#" class="btn btn-light"><img src="{{ asset('home/images/appleicon.png') }}" alt="icon"> App Store</a>
                    <a href="#" class="btn btn-light"><img src="{{ asset('home/images/playicon.png') }}" alt="icon"> Google play</a>
                </div>
