            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control {{ $errors->has('nama_penumpang') ? 'is-invalid' : '' }}" placeholder="Nama lengkap"
                  name="nama_penumpang" value="{{ auth()->guard('penumpang')->user()->nama_penumpang }}">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" placeholder="Alamat email"
                  name="email" value="{{ auth()->guard('penumpang')->user()->email }}">
                  <div class="invalid-feedback">
                    {{ $errors->first('email') }}
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" placeholder="Nama pengguna"
                  name="username" value="{{ auth()->guard('penumpang')->user()->username }}">
                  <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" placeholder="Nomor SIM/KTP"
                  name="no_identitas" value="{{ auth()->guard('penumpang')->user()->no_identitas }}">
                </div>
              </div>
              <div class="col-md-4">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      name="telefone" value="{{ auth()->guard('penumpang')->user()->telefone }}">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  name="tanggal_lahir" value="{{ is_null(auth()->guard('penumpang')->user()->tanggal_lahir) ? '' : auth()->guard('penumpang')->user()->tanggal_lahir }}">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group d-flex justify-content-center align-items-center">
                  <div class="">
                    ...
                    <img src="{{ asset('home/images/client.png') }}" class="img-fluid" style="border-radius: 50%;" alt="">
                    @else
                    <img src="{{ asset('uploads/images/avatars/' . auth()->guard('penumpang')->user()->image) }}" class="img-fluid" style="border-radius: 50%;" alt="" width="100">
                    @endif
                  </div>
                </div>
