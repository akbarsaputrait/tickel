@extends('master_admin') @section('title', '#'.$pemesanan->kode_pemesanan) @section('content')
<div class="row">
  <div class="col-lg-12 grid-margin">
    <div class="d-flex justify-content-end mb-3">
      <div>
        ...
        <a href="{{ route('admin.export.pdf', ['kode_pemesanan' => $pemesanan->kode_pemesanan]) }}" class="btn btn-success">
    ...
    <div class="card">
      <div class="card-body">
        <form class="form-horizontal" method="post" action="{{ route('admin.order.update', ['order' => $pemesanan->kode_pemesanan]) }}">
          @csrf
          @method('PUT')
          <fieldset disabled>
            <div class="printIt">
